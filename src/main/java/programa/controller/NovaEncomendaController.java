...
import programa.app.NovaEncomendaApp;
...
//					FormataData.retornaMes(), FormataData.retornaAno(), valor, situacao,p.getIdProduto());
			...
			a.setContentText("Encomenda inserida com sucesso no sistema");
			a.setHeaderText("Sucesso");
			a.setTitle("Encomenda inserida");
	
			a.showAndWait();
			//new PrincipalApp().start(new Stage());
			NovaEncomendaApp.getStage().close();
